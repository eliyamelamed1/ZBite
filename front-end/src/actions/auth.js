...
export const loadUserListAction = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `${process.env.REACT_APP_API_URL}/api/accounts/list/`,
      config
    );
...
export const loadLoggedUserDetailsAction = (socket) => async (dispatch) => {
  if (localStorage.getItem("key")) {
    ...
    try {
      const res = await axios.get(
        `${process.env.REACT_APP_API_URL}/api/djoser/users/me/`,
        config
      );
...
export const signupAction =
  ...
  async (dispatch) => {
    ...
    try {
      const res = await axios.post(
        `${process.env.REACT_APP_API_URL}/api/djoser/users/`,
        body,
        config
      );
...
export const verify = (uid, token) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `${process.env.REACT_APP_API_URL}/api/djoser/users/activation/`,
      body,
      config
    );
