...
export const GET_USER_OWN_RECIPES_LIST_SUCCESS = 'GET_USER_OWN_RECIPES_LIST_SUCCESS';
export const GET_USER_OWN_RECIPES_LIST_FAIL = 'GET_USER_OWN_RECIPES_LIST_FAIL';
